...
<!--
	...
	an md:SPSSODescriptor child element in the output. If a particular 
	entity in the input does not contain an md:SPSSODescriptor, the 
...
<xsl:stylesheet version="1.0"
	...
	<!-- remove all entities that do not contain an md:SPSSODescriptor -->
	<xsl:template match="md:EntityDescriptor[not(md:SPSSODescriptor)]"/>
</xsl:stylesheet>
